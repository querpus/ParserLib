...
public struct ParsingInfo : IEquatable<ParsingInfo>
{
  ...
  /// If <see langword="true"/>,The parser will make a single <see cref="IEntity"/> object from the data.<br/>
  /// If <see langword="false"/>, the parser will make a <see cref="Collection{T}"/> of <see cref="IEntity"/> objects.</remarks>
